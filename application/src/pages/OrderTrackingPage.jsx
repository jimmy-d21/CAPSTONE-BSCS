...
const STEPS = [
  ...
  },
  {
    ...
    label: "Grilling",
    icon: Flame,
    desc: "Our chefs are grilling your order",
  },
  {
    key: "ready",
    label: "Ready",
  ...
  },
  {
    ...
    label: "On the Way",
    icon: Bike,
    desc: "Rider is heading your way",
  },
  {
    key: "delivered",
    label: "Delivered!",
    icon: CheckCircle,
    desc: "Enjoy your meal! Salamat!",
  },
];
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    position: "relative",
                    paddingBottom: idx < STEPS.length - 1 ? "20px" : "6px",
                  }}
                >
                  {idx < STEPS.length - 1 && (
                    <div
                  ...
                  <div style={{ flex: 1, paddingTop: "3px" }}>
                    <p
                      style={{
                        ...
                        color: done ? "var(--text-1)" : "var(--text-4)",
